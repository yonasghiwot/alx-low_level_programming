 ...
 * @h: pointer to the first elements of a singly linked list of
 * structs of type listint_s
...
/**
 * get_nodeint_at_index - func returns address of 'index'th member of
...
/**
 * delete_nodeint_at_index - func deletes a node from a listint_t
 * linked list at index position index
